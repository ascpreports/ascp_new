...
public class ypSearchPro extends TestBase{
	
	public ypSearchPro(WebDriver dr){
		driver=dr;
	...
	public WebElement ypSearchProHeader_Nav;
	
	@FindBy(xpath="html/body/div[1]/div/h1")
	public WebElement page_Title;
	
	@FindBy(xpath= "html/body/div[1]/div/div[1]/div/ul/li[1]/a")
	public WebElement overview_Tab;
	
	@FindBy(xpath= "html/body/div[1]/div/div[2]/div/ul/li[1]/a")
	public WebElement overview_Tab_guest;
	
	@FindBy(xpath= "html/body/div[1]/div/div[1]/div/ul/li[2]/a")
	public WebElement ads_Tab;
	
	@FindBy(xpath= "html/body/div[1]/div/div[2]/div/ul/li[2]/a")
	public WebElement ads_Tab_guest;
	
	@FindBy(xpath= "html/body/div[1]/div/div[1]/div/ul/li[3]/a")
	public WebElement keywords_Tab;
	
	@FindBy(xpath= "html/body/div[1]/div/div[2]/div/ul/li[3]/a")
	public WebElement keywords_Tab_guest;
	...
	public final String PARENT_TOP_SECTION = "//*[@id='rptfilter']";
	public final String CHILD_TOP_SECTION = "//*[@id='rptfilter']/*";
	...
	public HashMap<String, WebElement> launchURL(String url, String guestMode){
		...
		if(!isElementPresent(LOCALADS_OVERVIEW)){
			...
			gotoWebElementByMouse(driver, ypSearchProHeader_Nav);
			waitForPageToLoad();
			if(guestMode.equals("Y")){
				hmap.put("OVERVIEW_TAB", overview_Tab_guest);
				hmap.put("ADS_TAB",  ads_Tab_guest);
				hmap.put("KEYWORDS_TAB", keywords_Tab_guest);
			}else{
				//driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
				hmap.put("OVERVIEW_TAB", overview_Tab);
				hmap.put("ADS_TAB",  ads_Tab);
				hmap.put("KEYWORDS_TAB", keywords_Tab);
			}
	...
	public HashMap<WebElement, String> ypSearchProOverview(String guestMode) throws InterruptedException{
	...
	public int ypSearchProTopSection(){
		int i=0;
