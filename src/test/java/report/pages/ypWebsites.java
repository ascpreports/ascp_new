...
public class ypWebsites extends TestBase{
	
	public ypWebsites(WebDriver dr){
		driver=dr;
	...
	@FindBy(xpath= "//*[@id='contentContainer']/div[3]/div/span[1]")
	...
	public HashMap<WebElement, String> ypWebsitesOverview(String guestMode) throws InterruptedException{
	...
	public int ypWebsitesBottomSection(){
		int i=0;
